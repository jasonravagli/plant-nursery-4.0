...
import it.unifi.dinfo.swam.plantnursery.nosql.controller.GrowthPlaceController;
...
public class GrowthPlaceEndpoint {
	...
	public Response deleteGrowthPlace(@PathParam("id") UUID id) {
	...
	@Path("{id}")
	@Produces(MediaType.APPLICATION_JSON)
	public Response getGrowthPlaceById(@PathParam("id") UUID id) {
	...
	@Consumes(MediaType.APPLICATION_JSON)
	@Produces(MediaType.APPLICATION_JSON)
	public Response updateGrowthPlace(@PathParam("id") UUID idGrowthPlace, GrowthPlaceDto growthPlace) {
